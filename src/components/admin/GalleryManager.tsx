    ...
    <div className="space-y-8">
      ...
      >
        ...
        <form onSubmit={handleUpload} className="space-y-4">
                  ...
                  {showUploadCategoryDropdown && (
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-2 px-3 py-2 text-left font-medium hover:bg-white hover:text-background transition-colors ${
                          uploadCategory === "events" ? "bg-white text-background" : "text-white"
                        }`}
                      >
                        <Calendar size={16} />
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-2 px-3 py-2 text-left font-medium hover:bg-white hover:text-background transition-colors ${
                          uploadCategory === "others" ? "bg-white text-background" : "text-white"
                        }`}
                      >
                        <Filter size={16} />
          ...
          <div className="mb-4">
            <label className="block text-white text-xs font-bold mb-1 uppercase">Image File</label>
            <input
              type="file"
              accept="image/*"
              ref={fileInputRef}
      ...
      >
        ...
        {loading ? (
          <div className="flex items-center justify-center py-8">
            ...
            />
            <span className="ml-3 text-white font-bold uppercase">Loading images...</span>
          </div>
