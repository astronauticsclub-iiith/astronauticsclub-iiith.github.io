      ...
      >
        ...
        <form onSubmit={handleAddInventoryItem} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            ...
            {/* Year of Purchase */}
            <div>
              <label className="block text-white text-xs font-bold mb-1 uppercase">Year</label>
              <input
                type="number"
                placeholder="YEAR"
      ...
      >
        ...
        {inventoryLoading ? (
          <div className="flex items-center justify-center py-8">
            ...
            />
            <span className="ml-3 text-white font-bold uppercase">Loading inventory items...</span>
          </div>
        ) : inventory.length === 0 ? (
