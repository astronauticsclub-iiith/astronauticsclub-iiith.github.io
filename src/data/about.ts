...
export const aboutUsContent: AboutParagraph[] = [
  {
    para: 1,
    content: `Who hasn't been captivated by the serene vastness of the midnight sky, 
              ...
              yearned to deepen this connection, look no further into your childhood dream.`,
  },
  {
    para: 2,
    content: `Astronautics Club at IIIT Hyderabad is a vibrant student-run community 
  ...
  {
    para: 3,
    content: `Whether you are a seasoned stargazer or a curious beginner, we welcome 
